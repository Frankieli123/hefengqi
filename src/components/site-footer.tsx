  ...
  return (
    <footer className="bg-ink text-ink-foreground">
      <div className="page-shell grid gap-12 py-14 md:grid-cols-[1.6fr_1fr_1fr]">
        ...
        <nav className="flex flex-col gap-3 text-sm" aria-label="Footer products"><strong>{t("products")}</strong><Link href="/products">{t("products")}</Link><Link href="/solutions">{t("solutions")}</Link></nav>
