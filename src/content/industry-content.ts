...
export const industryContent: IndustryContentDefinition[] = [
  {
    ...
    translations: {
      ...
      en: {
        ...
        body: [
          "Data center selection starts with load, redundancy targets, incoming power, available space, and the expansion plan. RICEWIND turns these site constraints into a structured requirement so project teams can define the power path, cooling approach, and delivery boundary before requesting quotations.",
      ...
      ru: {
        ...
        body: [
          "Подбор инфраструктуры ЦОД начинается с нагрузки, требований к резервированию, параметров ввода, доступного пространства и плана расширения. RICEWIND преобразует эти ограничения в структурированное техническое задание, чтобы до запроса цены определить схему питания, способ охлаждения и границы поставки.",
    ...
    translations: {
      ...
      en: {
        ...
        body: [
          ...
          "SFP optical modules, KVM, and monitoring interfaces are checked for speed, reach, fiber type, protocol, and equipment compatibility. RICEWIND organizes the bill of materials around exact models and source documents for procurement, delivery, and maintenance.",
        ],
      ...
      ru: {
        ...
        body: [
          ...
          "Для модулей SFP, KVM и мониторинга проверяются скорость, дальность, тип волокна, протокол и совместимость. RICEWIND формирует перечень по точным моделям и исходным документам для закупки, поставки и обслуживания.",
        ],
    ...
    translations: {
      ...
      en: {
        ...
        body: [
          ...
          "RICEWIND organizes power, cooling, PDU, KVM, and network products into a reviewable shortlist without describing standard industrial equipment as medically certified. Final configurations remain subject to design documents, manufacturer evidence, and local compliance review.",
        ],
      ...
      ru: {
        ...
        body: [
          ...
          "RICEWIND формирует проверяемый перечень питания, охлаждения, PDU, KVM и сетевого оборудования, не выдавая стандартные промышленные изделия за медицинские. Итоговая конфигурация подтверждается проектной документацией, данными производителя и местными требованиями.",
        ],
    ...
    translations: {
      ...
      en: {
        ...
        body: [
          ...
          "A unified list covering power, cooling, PDU, KVM, and communications modules reduces interface gaps across multiple suppliers. RICEWIND structures the shortlist around manufacturer documents and project constraints, preserving a clear verification path for procurement.",
        ],
      ...
      ru: {
        ...
        body: [
          ...
          "Единый перечень питания, охлаждения, PDU, KVM и коммуникационных модулей снижает риск пропуска интерфейсов при поставках разных производителей. RICEWIND формирует список по документации и ограничениям проекта с понятной проверкой параметров на этапе закупки.",
        ],
